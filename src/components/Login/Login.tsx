    ...
    <div>
      ...
      {!userContext.user && (
        ...
        <div className={styles.loginContainer}>
          ...
          <div className={`${styles.formElement} ${styles.loginGoogle}`} onClick={signInWithGoogle}>
          ...
          <p className={styles.testUserLogin} onClick={signInAsTestUser}>{">"} Login as test user {"<"}</p>
        </div>
        </>
      )}
    </div>
